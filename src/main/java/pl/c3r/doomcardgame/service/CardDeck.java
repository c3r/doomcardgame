...
public class CardDeck {
    ...
    public CardDeck() {
        ...
        monsterCards = new Deck<>("Monsters", Stream.of(
                MonsterCard.builder().id(300).initiativeBonus(0).monster(imp).build(),
                MonsterCard.builder().id(301).initiativeBonus(0).monster(imp).build(),
                MonsterCard.builder().id(302).initiativeBonus(0).monster(imp).build(),
                MonsterCard.builder().id(303).initiativeBonus(0).monster(imp).build(),
                MonsterCard.builder().id(304).initiativeBonus(0).monster(imp).build(),
                MonsterCard.builder().id(305).initiativeBonus(0).monster(imp).build(),
                MonsterCard.builder().id(306).initiativeBonus(0).monster(imp).build(),
                MonsterCard.builder().id(307).initiativeBonus(0).monster(imp).build(),
                MonsterCard.builder().id(308).initiativeBonus(0).monster(imp).build(),
                MonsterCard.builder().id(309).initiativeBonus(0).monster(imp).build(),
                MonsterCard.builder().id(310).initiativeBonus(0).monster(imp).build(),
                MonsterCard.builder().id(311).initiativeBonus(0).monster(cacodemon).build(),
                MonsterCard.builder().id(312).initiativeBonus(0).monster(cacodemon).build(),
                MonsterCard.builder().id(313).initiativeBonus(0).monster(cacodemon).build(),
                MonsterCard.builder().id(314).initiativeBonus(0).monster(cacodemon).build(),
                MonsterCard.builder().id(315).initiativeBonus(0).monster(cacodemon).build(),
                MonsterCard.builder().id(316).initiativeBonus(0).monster(cacodemon).build(),
                MonsterCard.builder().id(317).initiativeBonus(0).monster(cacodemon).build(),
                MonsterCard.builder().id(318).initiativeBonus(0).monster(cacodemon).build(),
                MonsterCard.builder().id(319).initiativeBonus(0).monster(cacodemon).build(),
                MonsterCard.builder().id(320).initiativeBonus(0).monster(baron).build(),
                MonsterCard.builder().id(321).initiativeBonus(0).monster(baron).build(),
                MonsterCard.builder().id(322).initiativeBonus(0).monster(baron).build(),
                MonsterCard.builder().id(323).initiativeBonus(0).monster(baron).build(),
                MonsterCard.builder().id(324).initiativeBonus(0).monster(lostSoul).build(),
                MonsterCard.builder().id(325).initiativeBonus(0).monster(lostSoul).build(),
                MonsterCard.builder().id(326).initiativeBonus(0).monster(lostSoul).build(),
                MonsterCard.builder().id(327).initiativeBonus(0).monster(lostSoul).build()
